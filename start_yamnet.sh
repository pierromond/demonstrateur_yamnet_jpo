...
python3 src/yamnetgui/zero_trigger.py --yamnet_window_time 1 --yamnet_class_map src/yamnetgui/resources/yamnet_class_threshold_map_fr.csv --yamnet_weights yamnet.tflite --yamnet_max_gain 3 --yamnet_cutoff_frequency 200
